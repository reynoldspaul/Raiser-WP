<div class="wrap">
	...
	<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">	
		...
		<input type="hidden" name="action" value="raiser_command_block">
		<?php wp_nonce_field( 'raiser_command_block', 'block' ); ?>
	...
	<a href="https://raiserweb.github.io/Raiser-WP-Docs/docs/blocks" target="_blank">Documentation <span class="dashicons-before dashicons-external"></span></a>
